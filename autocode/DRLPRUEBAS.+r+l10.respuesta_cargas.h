...
//==================================================================
#ifndef DRLPRUEBAS__RL10_respuesta_cargas_H
#define DRLPRUEBAS__RL10_respuesta_cargas_H

#include <INTEG_simula.h>

class DRLPRUEBAS__RL10_respuesta_cargas: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__RL10_respuesta_cargas(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__RL10_respuesta_cargas* s_current;
public: 
