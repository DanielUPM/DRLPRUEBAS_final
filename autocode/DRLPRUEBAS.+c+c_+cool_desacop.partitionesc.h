...
//==================================================================
#ifndef DRLPRUEBAS__CC_Cool_desacop_partitionesc_H
#define DRLPRUEBAS__CC_Cool_desacop_partitionesc_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Cool_desacop_partitionesc: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Cool_desacop_partitionesc(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Cool_desacop_partitionesc* s_current;
public: 
