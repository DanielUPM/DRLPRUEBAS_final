...
//==================================================================
#ifndef DRLPRUEBAS__CC_Gen_OFFD_OFFDvalidate_H
#define DRLPRUEBAS__CC_Gen_OFFD_OFFDvalidate_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Gen_OFFD_OFFDvalidate: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Gen_OFFD_OFFDvalidate(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Gen_OFFD_OFFDvalidate* s_current;
public: 
