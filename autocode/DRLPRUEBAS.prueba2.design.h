...
//==================================================================
#ifndef DRLPRUEBAS__prueba2_design_H
#define DRLPRUEBAS__prueba2_design_H

#include <INTEG_simula.h>

class DRLPRUEBAS__prueba2_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__prueba2_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__prueba2_design* s_current;
public: 
