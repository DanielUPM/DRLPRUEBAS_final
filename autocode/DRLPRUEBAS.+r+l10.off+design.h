...
//==================================================================
#ifndef DRLPRUEBAS__RL10_offDesign_H
#define DRLPRUEBAS__RL10_offDesign_H

#include <INTEG_simula.h>

class DRLPRUEBAS__RL10_offDesign: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__RL10_offDesign(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__RL10_offDesign* s_current;
public: 
