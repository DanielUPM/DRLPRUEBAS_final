...
//==================================================================
#include "DRLPRUEBAS.+g+g_comp.escalon.exp_rap.h"

DRLPRUEBAS__GG_comp_escalon_exp_rap* DRLPRUEBAS__GG_comp_escalon_exp_rap::s_current= NULL;
DRLPRUEBAS__GG_comp_escalon_exp_rap::DRLPRUEBAS__GG_comp_escalon_exp_rap(const char* mgr,const char* installDir,bool dmode):DRLPRUEBAS__GG_comp_escalon(mgr,installDir,dmode)
{
m_infoLibraryName = "DRLPRUEBAS";
m_infoExperimentName = "exp_rap";
m_infoExperimentFileName = "DRLPRUEBAS.+g+g_comp.escalon.exp_rap";
m_infoExperimentFileNameExtra = "exp_rap";
m_infoExperimentDate = "22/06/2018 10:29:54.905000";
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::initInternalModels()
{
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::addExptVariables()
{
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::runExperiment()
{
	DEBUG_LEVEL = 4 ;
	IMETHOD = 11 ;
	eSetConfig(1, 1) ;
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void DRLPRUEBAS__GG_comp_escalon_exp_rap::initDefaultsExp()
{
	dyn[0] = 1. ;
	dyn[1] = 2500. ;
	dyn[2] = 10. ;
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
...
void DRLPRUEBAS__GG_comp_escalon_exp_rap::initDelaysExpt()
{
}
...
try
{
	...
	DRLPRUEBAS__GG_comp_escalon_exp_rap ecomodel;
#else
	DRLPRUEBAS__GG_comp_escalon_exp_rap ecomodel(0,0,true);
...
{
	return new DRLPRUEBAS__GG_comp_escalon_exp_rap(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new DRLPRUEBAS__GG_comp_escalon_exp_rap(name,dirInstall,d);
