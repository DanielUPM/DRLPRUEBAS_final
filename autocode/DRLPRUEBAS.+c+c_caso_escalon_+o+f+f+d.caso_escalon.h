...
//==================================================================
#ifndef DRLPRUEBAS__CC_caso_escalon_OFFD_caso_escalon_H
#define DRLPRUEBAS__CC_caso_escalon_OFFD_caso_escalon_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_caso_escalon_OFFD_caso_escalon: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_caso_escalon_OFFD_caso_escalon(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_caso_escalon_OFFD_caso_escalon* s_current;
public: 
