...
//==================================================================
#ifndef DRLPRUEBAS__RL10_partition3_H
#define DRLPRUEBAS__RL10_partition3_H

#include <INTEG_simula.h>

class DRLPRUEBAS__RL10_partition3: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__RL10_partition3(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__RL10_partition3* s_current;
public: 
