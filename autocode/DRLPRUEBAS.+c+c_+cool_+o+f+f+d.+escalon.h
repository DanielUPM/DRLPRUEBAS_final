...
//==================================================================
#ifndef DRLPRUEBAS__CC_Cool_OFFD_Escalon_H
#define DRLPRUEBAS__CC_Cool_OFFD_Escalon_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Cool_OFFD_Escalon: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Cool_OFFD_Escalon(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Cool_OFFD_Escalon* s_current;
public: 
