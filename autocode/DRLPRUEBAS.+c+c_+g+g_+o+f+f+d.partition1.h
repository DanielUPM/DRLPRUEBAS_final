...
//==================================================================
#ifndef DRLPRUEBAS__CC_GG_OFFD_partition1_H
#define DRLPRUEBAS__CC_GG_OFFD_partition1_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_GG_OFFD_partition1: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_GG_OFFD_partition1(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_GG_OFFD_partition1* s_current;
public: 
