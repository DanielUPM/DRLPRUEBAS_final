...
//==================================================================
#ifndef DRLPRUEBAS__prueba2_transient_H
#define DRLPRUEBAS__prueba2_transient_H

#include <INTEG_simula.h>

class DRLPRUEBAS__prueba2_transient: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__prueba2_transient(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__prueba2_transient* s_current;
public: 
