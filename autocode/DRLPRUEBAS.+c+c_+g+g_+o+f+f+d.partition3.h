...
//==================================================================
#ifndef DRLPRUEBAS__CC_GG_OFFD_partition3_H
#define DRLPRUEBAS__CC_GG_OFFD_partition3_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_GG_OFFD_partition3: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_GG_OFFD_partition3(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_GG_OFFD_partition3* s_current;
public: 
