...
//==================================================================
#ifndef DRLPRUEBAS__GG_comp_OFFD_valid_H
#define DRLPRUEBAS__GG_comp_OFFD_valid_H

#include <INTEG_simula.h>

class DRLPRUEBAS__GG_comp_OFFD_valid: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__GG_comp_OFFD_valid(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__GG_comp_OFFD_valid* s_current;
public: 
