...
//==================================================================
#ifndef DRLPRUEBAS__CC_completa_OFFD_offDesign_steady_H
#define DRLPRUEBAS__CC_completa_OFFD_offDesign_steady_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_completa_OFFD_offDesign_steady: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_completa_OFFD_offDesign_steady(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_completa_OFFD_offDesign_steady* s_current;
public: 
