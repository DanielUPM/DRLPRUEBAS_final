...
//==================================================================
#ifndef DRLPRUEBAS__CC_Cool_desacop_partition_offd_H
#define DRLPRUEBAS__CC_Cool_desacop_partition_offd_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Cool_desacop_partition_offd: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Cool_desacop_partition_offd(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Cool_desacop_partition_offd* s_current;
public: 
