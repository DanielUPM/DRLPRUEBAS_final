...
//==================================================================
#ifndef DRLPRUEBAS__prueba2_offdesign_H
#define DRLPRUEBAS__prueba2_offdesign_H

#include <INTEG_simula.h>

class DRLPRUEBAS__prueba2_offdesign: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__prueba2_offdesign(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__prueba2_offdesign* s_current;
public: 
