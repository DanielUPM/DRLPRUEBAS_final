...
//==================================================================
#ifndef DRLPRUEBAS__CC_Cool_OFFD_OFFD_validate_H
#define DRLPRUEBAS__CC_Cool_OFFD_OFFD_validate_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Cool_OFFD_OFFD_validate: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Cool_OFFD_OFFD_validate(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Cool_OFFD_OFFD_validate* s_current;
public: 
