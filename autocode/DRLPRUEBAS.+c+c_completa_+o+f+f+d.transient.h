...
//==================================================================
#ifndef DRLPRUEBAS__CC_completa_OFFD_transient_H
#define DRLPRUEBAS__CC_completa_OFFD_transient_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_completa_OFFD_transient: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_completa_OFFD_transient(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_completa_OFFD_transient* s_current;
public: 
