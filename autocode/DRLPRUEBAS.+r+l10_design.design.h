...
//==================================================================
#ifndef DRLPRUEBAS__RL10_design_design_H
#define DRLPRUEBAS__RL10_design_design_H

#include <INTEG_simula.h>

class DRLPRUEBAS__RL10_design_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__RL10_design_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__RL10_design_design* s_current;
public: 
