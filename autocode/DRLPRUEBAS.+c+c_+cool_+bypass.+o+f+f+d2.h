...
//==================================================================
#ifndef DRLPRUEBAS__CC_Cool_Bypass_OFFD2_H
#define DRLPRUEBAS__CC_Cool_Bypass_OFFD2_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_Cool_Bypass_OFFD2: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_Cool_Bypass_OFFD2(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_Cool_Bypass_OFFD2* s_current;
public: 
