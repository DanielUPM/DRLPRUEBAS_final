...
//==================================================================
#include "DRLPRUEBAS.+r+l10.respuesta_cargas.exp2.h"

DRLPRUEBAS__RL10_respuesta_cargas_exp2* DRLPRUEBAS__RL10_respuesta_cargas_exp2::s_current= NULL;
DRLPRUEBAS__RL10_respuesta_cargas_exp2::DRLPRUEBAS__RL10_respuesta_cargas_exp2(const char* mgr,const char* installDir,bool dmode):DRLPRUEBAS__RL10_respuesta_cargas(mgr,installDir,dmode)
{
m_infoLibraryName = "DRLPRUEBAS";
m_infoExperimentName = "exp2";
m_infoExperimentFileName = "DRLPRUEBAS.+r+l10.respuesta_cargas.exp2";
m_infoExperimentFileNameExtra = "exp2";
m_infoExperimentDate = "20/06/2018 09:53:32.135000";
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::initInternalModels()
{
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::addExptVariables()
{
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::runExperiment()
{
	DEBUG_LEVEL = 4 ;
	IMETHOD = 11 ;
	eSetConfig(1, 1) ;
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::initDefaultsExp()
{
	dyn[0] = 1. ;
	dyn[1] = 2500. ;
	dyn[2] = 10. ;
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
...
void DRLPRUEBAS__RL10_respuesta_cargas_exp2::initDelaysExpt()
{
}
...
try
{
	...
	DRLPRUEBAS__RL10_respuesta_cargas_exp2 ecomodel;
#else
	DRLPRUEBAS__RL10_respuesta_cargas_exp2 ecomodel(0,0,true);
...
{
	return new DRLPRUEBAS__RL10_respuesta_cargas_exp2(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new DRLPRUEBAS__RL10_respuesta_cargas_exp2(name,dirInstall,d);
