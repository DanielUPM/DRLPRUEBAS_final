...
//==================================================================
#ifndef DRLPRUEBAS__F1_offDesign_H
#define DRLPRUEBAS__F1_offDesign_H

#include <INTEG_simula.h>

class DRLPRUEBAS__F1_offDesign: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__F1_offDesign(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__F1_offDesign* s_current;
public: 
