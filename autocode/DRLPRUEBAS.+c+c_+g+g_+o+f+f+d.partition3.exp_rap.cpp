...
//==================================================================
#include "DRLPRUEBAS.+c+c_+g+g_+o+f+f+d.partition3.exp_rap.h"

DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap* DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::s_current= NULL;
DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap(const char* mgr,const char* installDir,bool dmode):DRLPRUEBAS__CC_GG_OFFD_partition3(mgr,installDir,dmode)
{
m_infoLibraryName = "DRLPRUEBAS";
m_infoExperimentName = "exp_rap";
m_infoExperimentFileName = "DRLPRUEBAS.+c+c_+g+g_+o+f+f+d.partition3.exp_rap";
m_infoExperimentFileNameExtra = "exp_rap";
m_infoExperimentDate = "27/06/2018 13:18:34.524000";
...
static double __exp_tab_1[] = {0,2,4,15,301.365293,301.365293,401.365293,401.365293};
static INTEG_table tmp_tab_T[] = { INTEG_table(4, __exp_tab_1+0, 0, NULL, 0, NULL, __exp_tab_1+4, "tab_T")};
tab_T = tmp_tab_T[0];
static double __exp_tab_2[] = {0,2,4,15,13101196,13101196,13601196,13601196};
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::initInternalModels()
{
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::addExptVariables()
{
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::runExperiment()
{
	DEBUG_LEVEL = 4 ;
	IMETHOD = 11 ;
	eSetConfig(1, 1) ;
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::initDefaultsLibraryGlobalsInExp()
{
}

/* Initialisation of variables in experiment*/
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::initDefaultsExp()
{
	dyn[0] = 10. ;
	dyn[1] = 2500. ;
	dyn[2] = 50. ;
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::evalBoundsExp(double TIME)
{
	if (m_boundsLaw)
...
void DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap::initDelaysExpt()
{
}
...
try
{
	...
	DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap ecomodel;
#else
	DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap ecomodel(0,0,true);
...
{
	return new DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap(name,dirInstall,d);
}
...
SIMULA_EXPORT_C_EXP INTEG_SlimSimula *fcnExpCreate2(const char *name=NULL,const char *dirInstall=NULL,bool d=false)
{
	...
	try
	{
		INTEG_simula * tmp = new DRLPRUEBAS__CC_GG_OFFD_partition3_exp_rap(name,dirInstall,d);
