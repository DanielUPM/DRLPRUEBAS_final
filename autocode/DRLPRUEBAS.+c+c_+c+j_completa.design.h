...
//==================================================================
#ifndef DRLPRUEBAS__CC_CJ_completa_design_H
#define DRLPRUEBAS__CC_CJ_completa_design_H

#include <INTEG_simula.h>

class DRLPRUEBAS__CC_CJ_completa_design: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__CC_CJ_completa_design(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__CC_CJ_completa_design* s_current;
public: 
