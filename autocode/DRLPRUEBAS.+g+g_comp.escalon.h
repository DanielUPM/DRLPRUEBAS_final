...
//==================================================================
#ifndef DRLPRUEBAS__GG_comp_escalon_H
#define DRLPRUEBAS__GG_comp_escalon_H

#include <INTEG_simula.h>

class DRLPRUEBAS__GG_comp_escalon: public INTEG_simula
{
public:
	// methods to cope with the continuous part
	DRLPRUEBAS__GG_comp_escalon(const char *mgr=NULL,const char *dirInstall=NULL,bool dmode=false);
	...
	static DRLPRUEBAS__GG_comp_escalon* s_current;
public: 
